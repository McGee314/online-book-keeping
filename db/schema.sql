...
CREATE TABLE IF NOT EXISTS `transactions` (
    ...
    `type`          TINYINT(1)       NOT NULL                COMMENT '1=income, 2=expense',
    `amount`        DECIMAL(12, 2)   NOT NULL                COMMENT 'Original amount in transaction currency',
    `currency_code` VARCHAR(10)      NOT NULL DEFAULT 'IDR'  COMMENT 'Currency code (IDR, CNY, USD)',
    `base_amount`   DECIMAL(12, 2)   NOT NULL                COMMENT 'Converted amount in base currency (IDR)',
